...
mrb_bnd_init(mrb_state *mrb, struct RClass *mod)
{
  ...
  mrb_define_method(mrb, bnd_class, "theme",                    bnd_get_theme,                MRB_ARGS_NONE());
  mrb_define_method(mrb, bnd_class, "icon_image=",              bnd_set_icon_image,           MRB_ARGS_REQ(1));
  mrb_define_method(mrb, bnd_class, "font=",                    bnd_set_font,                 MRB_ARGS_REQ(1));
  mrb_define_method(mrb, bnd_class, "label",                    bnd_label,                    MRB_ARGS_REQ(7));
  mrb_define_method(mrb, bnd_class, "tool_button",              bnd_tool_button,              MRB_ARGS_REQ(9));
  mrb_define_method(mrb, bnd_class, "radio_button",             bnd_radio_button,             MRB_ARGS_REQ(9));
  mrb_define_method(mrb, bnd_class, "text_field_text_position", bnd_text_field_text_position, MRB_ARGS_REQ(9));
  mrb_define_method(mrb, bnd_class, "text_field",               bnd_text_field,               MRB_ARGS_REQ(11));
  mrb_define_method(mrb, bnd_class, "option_button",            bnd_option_button,            MRB_ARGS_REQ(7));
  mrb_define_method(mrb, bnd_class, "choice_button",            bnd_choice_button,            MRB_ARGS_REQ(9));
  mrb_define_method(mrb, bnd_class, "color_button",             bnd_color_button,             MRB_ARGS_REQ(7));
  mrb_define_method(mrb, bnd_class, "number_field",             bnd_number_field,             MRB_ARGS_REQ(9));
  mrb_define_method(mrb, bnd_class, "slider",                   bnd_slider,                   MRB_ARGS_REQ(10));
  mrb_define_method(mrb, bnd_class, "scroll_bar",               bnd_scroll_bar,               MRB_ARGS_REQ(8));
  mrb_define_method(mrb, bnd_class, "menu_background",          bnd_menu_background,          MRB_ARGS_REQ(6));
  mrb_define_method(mrb, bnd_class, "menu_label",               bnd_menu_label,               MRB_ARGS_REQ(7));
  mrb_define_method(mrb, bnd_class, "menu_item",                bnd_menu_item,                MRB_ARGS_REQ(8));
  mrb_define_method(mrb, bnd_class, "tooltip_background",       bnd_tooltip_background,       MRB_ARGS_REQ(5));
  mrb_define_method(mrb, bnd_class, "node_port",                bnd_node_port,                MRB_ARGS_REQ(5));
  mrb_define_method(mrb, bnd_class, "node_wire",                bnd_node_wire,                MRB_ARGS_REQ(7));
  mrb_define_method(mrb, bnd_class, "colored_node_wire",        bnd_colored_node_wire,        MRB_ARGS_REQ(7));
  mrb_define_method(mrb, bnd_class, "node_background",          bnd_node_background,          MRB_ARGS_REQ(9));
  mrb_define_method(mrb, bnd_class, "splitter_widgets",         bnd_splitter_widgets,         MRB_ARGS_REQ(5));
  mrb_define_method(mrb, bnd_class, "join_area_overlay",        bnd_join_area_overlay,        MRB_ARGS_REQ(7));
  mrb_define_method(mrb, bnd_class, "label_width",              bnd_label_width,              MRB_ARGS_REQ(3));
  mrb_define_method(mrb, bnd_class, "label_height",             bnd_label_height,             MRB_ARGS_REQ(4));
  mrb_define_method(mrb, bnd_class, "transparent",              bnd_transparent,              MRB_ARGS_REQ(1));
  mrb_define_method(mrb, bnd_class, "offset_color",             bnd_offset_color,             MRB_ARGS_REQ(2));
  mrb_define_method(mrb, bnd_class, "select_corners",           bnd_select_corners,           MRB_ARGS_REQ(2));
  mrb_define_method(mrb, bnd_class, "inner_colors",             bnd_inner_colors,             MRB_ARGS_REQ(5));
  mrb_define_method(mrb, bnd_class, "text_color",               bnd_text_color,               MRB_ARGS_REQ(2));
  mrb_define_method(mrb, bnd_class, "scroll_handle_rect",       bnd_scroll_handle_rect,       MRB_ARGS_REQ(6));
  mrb_define_method(mrb, bnd_class, "rounded_box",              bnd_rounded_box,              MRB_ARGS_REQ(9));
  mrb_define_method(mrb, bnd_class, "background",               bnd_background,               MRB_ARGS_REQ(5));
  mrb_define_method(mrb, bnd_class, "bevel",                    bnd_bevel,                    MRB_ARGS_REQ(5));
  mrb_define_method(mrb, bnd_class, "bevel_inset",              bnd_bevel_inset,              MRB_ARGS_REQ(7));
  mrb_define_method(mrb, bnd_class, "icon",                     bnd_icon,                     MRB_ARGS_REQ(4));
  mrb_define_method(mrb, bnd_class, "drop_shadow",              bnd_drop_shadow,              MRB_ARGS_REQ(8));
  mrb_define_method(mrb, bnd_class, "inner_box",                bnd_inner_box,                MRB_ARGS_REQ(11));
  mrb_define_method(mrb, bnd_class, "outline_box",              bnd_outline_box,              MRB_ARGS_REQ(10));
  mrb_define_method(mrb, bnd_class, "icon_label_value",         bnd_icon_label_value,         MRB_ARGS_REQ(11));
  mrb_define_method(mrb, bnd_class, "node_icon_label",          bnd_node_icon_label,          MRB_ARGS_REQ(11));
  mrb_define_method(mrb, bnd_class, "icon_label_text_position", bnd_icon_label_text_position, MRB_ARGS_REQ(10));
  mrb_define_method(mrb, bnd_class, "icon_label_caret",         bnd_icon_label_caret,         MRB_ARGS_REQ(12));
  mrb_define_method(mrb, bnd_class, "check",                    bnd_check,                    MRB_ARGS_REQ(4));
  mrb_define_method(mrb, bnd_class, "arrow",                    bnd_arrow,                    MRB_ARGS_REQ(5));
  mrb_define_method(mrb, bnd_class, "up_down_arrow",            bnd_up_down_arrow,            MRB_ARGS_REQ(5));
  mrb_define_method(mrb, bnd_class, "node_arrow_down",          bnd_node_arrow_down,          MRB_ARGS_REQ(5));
  mrb_define_method(mrb, bnd_class, "node_wire_color",          bnd_node_wire_color,          MRB_ARGS_REQ(2));

  mrb_bnd_widget_theme_init(mrb, bnd_class);
  ...
  /* BNDwidgetState */
  mrb_define_const(mrb, bnd_class, "DEFAULT", mrb_fixnum_value(BND_DEFAULT));
  mrb_define_const(mrb, bnd_class, "HOVER", mrb_fixnum_value(BND_HOVER));
  mrb_define_const(mrb, bnd_class, "ACTIVE", mrb_fixnum_value(BND_ACTIVE));
  /* BNDcornerFlags */
  mrb_define_const(mrb, bnd_class, "CORNER_NONE", mrb_fixnum_value(BND_CORNER_NONE));
  mrb_define_const(mrb, bnd_class, "CORNER_TOP_LEFT", mrb_fixnum_value(BND_CORNER_TOP_LEFT));
  mrb_define_const(mrb, bnd_class, "CORNER_TOP_RIGHT", mrb_fixnum_value(BND_CORNER_TOP_RIGHT));
  mrb_define_const(mrb, bnd_class, "CORNER_DOWN_RIGHT", mrb_fixnum_value(BND_CORNER_DOWN_RIGHT));
  mrb_define_const(mrb, bnd_class, "CORNER_DOWN_LEFT", mrb_fixnum_value(BND_CORNER_DOWN_LEFT));
  mrb_define_const(mrb, bnd_class, "CORNER_ALL", mrb_fixnum_value(BND_CORNER_ALL));
  mrb_define_const(mrb, bnd_class, "CORNER_TOP", mrb_fixnum_value(BND_CORNER_TOP));
  mrb_define_const(mrb, bnd_class, "CORNER_DOWN", mrb_fixnum_value(BND_CORNER_DOWN));
  mrb_define_const(mrb, bnd_class, "CORNER_LEFT", mrb_fixnum_value(BND_CORNER_LEFT));
  mrb_define_const(mrb, bnd_class, "CORNER_RIGHT", mrb_fixnum_value(BND_CORNER_RIGHT));
  /* Some other stuff */
  mrb_define_const(mrb, bnd_class, "WIDGET_HEIGHT", mrb_fixnum_value(BND_WIDGET_HEIGHT));
  mrb_define_const(mrb, bnd_class, "TOOL_WIDTH", mrb_fixnum_value(BND_TOOL_WIDTH));
  mrb_define_const(mrb, bnd_class, "NODE_PORT_RADIUS", mrb_fixnum_value(BND_NODE_PORT_RADIUS));
  mrb_define_const(mrb, bnd_class, "NODE_MARGIN_TOP", mrb_fixnum_value(BND_NODE_MARGIN_TOP));
  mrb_define_const(mrb, bnd_class, "NODE_MARGIN_DOWN", mrb_fixnum_value(BND_NODE_MARGIN_DOWN));
  mrb_define_const(mrb, bnd_class, "NODE_MARGIN_SIDE", mrb_fixnum_value(BND_NODE_MARGIN_SIDE));
  mrb_define_const(mrb, bnd_class, "NODE_TITLE_HEIGHT", mrb_fixnum_value(BND_NODE_TITLE_HEIGHT));
  mrb_define_const(mrb, bnd_class, "NODE_ARROW_AREA_WIDTH", mrb_fixnum_value(BND_NODE_ARROW_AREA_WIDTH));
  mrb_define_const(mrb, bnd_class, "SPLITTER_AREA_SIZE", mrb_fixnum_value(BND_SPLITTER_AREA_SIZE));
  mrb_define_const(mrb, bnd_class, "SCROLLBAR_WIDTH", mrb_fixnum_value(BND_SCROLLBAR_WIDTH));
  mrb_define_const(mrb, bnd_class, "SCROLLBAR_HEIGHT", mrb_fixnum_value(BND_SCROLLBAR_HEIGHT));
  mrb_define_const(mrb, bnd_class, "VSPACING", mrb_fixnum_value(BND_VSPACING));
  mrb_define_const(mrb, bnd_class, "VSPACING_GROUP", mrb_fixnum_value(BND_VSPACING_GROUP));
  mrb_define_const(mrb, bnd_class, "HSPACING", mrb_fixnum_value(BND_HSPACING));
  /* BNDicon */
